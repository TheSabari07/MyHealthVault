...
const FormControl = React.forwardRef<React.ElementRef<typeof Slot>, React.ComponentPropsWithoutRef<typeof Slot>>(({ ...props }, ref) => {
  ...
  return <Slot ref={ref} id={formItemId} aria-describedby={useFormField().error ? `${useFormField().formDescriptionId} ${useFormField().formMessageId}` : useFormField().formDescriptionId} aria-invalid={!!useFormField().error} {...props} />
})
